...
def collect_events(broll_path: str, captions_path: str) -> list[tuple[float, str, float]]:
    ...
    if os.path.exists(broll_path):
        ...
        for beat in plan:
            ...
            if kind in ("horizontal_timeline", "vertical_timeline", "list"):
                ...
                # i.e. when the orange scan-sweep passes over it. CommandDeck
                ...
                # Whisper-soft tick as each word lifts in; emphasis (orange) words
    ...
    # Caption emphasis: pen-scratch sound matching the orange underline wipe
