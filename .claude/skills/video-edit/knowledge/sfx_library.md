...
The TYPOGRAPHIC pop still fires (the orange underline still draws in) — only the audio sting is silenced.
...
4. **Match the visual semantics:**
   ...
   - Scratch → writing/drawing (caption underline, orange fill animation)
