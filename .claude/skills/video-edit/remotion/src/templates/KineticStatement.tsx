...
export const KineticStatement: React.FC<KineticStatementProps> = ({
  ...
  if (overlay) {
    ...
    // Alexandria bold ≈ 0.56·fontSize avg glyph advance; inter-word gap 0.3em.
...
const KineticWordSpan: React.FC<{
  ...
  const shadow = emph
    ? `0 2px 3px rgba(0,0,0,0.95), 0 ${fontSize * 0.06}px ${fontSize * 0.22}px rgba(0,0,0,0.75), 0 0 ${fontSize * 0.34}px rgba(255,122,0,0.35)`
