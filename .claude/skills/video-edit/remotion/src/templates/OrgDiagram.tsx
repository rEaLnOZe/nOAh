        ...
        {(() => {
          ...
          return (
            <div style={{
              ...
              boxShadow: `0 8px 24px rgba(0,0,0,0.25), 0 0 ${20 + 20 * pulseT}px rgba(255,122,0,${0.25 + 0.35 * pulseT})`,
        ...
        {nodes.map((n, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              boxShadow: n.kept
                ? `0 6px 16px rgba(255,122,0,${0.45 + 0.15 * Math.abs(Math.sin((frame / fps) * Math.PI * 1.4))})`
