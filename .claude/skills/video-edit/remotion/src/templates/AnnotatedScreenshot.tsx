...
export const AnnotatedScreenshot: React.FC<AnnotatedScreenshotProps> = ({ image_path, highlights, zoom_to_highlights }) => {
  ...
  const fontFamily = "Alexandria, system-ui, sans-serif";
      ...
      <div style={{
        ...
        {norm.map((h, i) => {
          ...
          return (
            ...
            >
              {/* TL corner */}
              <line x1={0} y1={0} x2={drawW} y2={0} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              <line x1={0} y1={0} x2={0} y2={drawH} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              {/* TR corner */}
              <line x1={w} y1={0} x2={w - drawW} y2={0} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              <line x1={w} y1={0} x2={w} y2={drawH} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              {/* BL corner */}
              <line x1={0} y1={ht} x2={drawW} y2={ht} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              <line x1={0} y1={ht} x2={0} y2={ht - drawH} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              {/* BR corner */}
              <line x1={w} y1={ht} x2={w - drawW} y2={ht} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
              <line x1={w} y1={ht} x2={w} y2={ht - drawH} stroke="#FF7A00" strokeWidth={strokeW} strokeLinecap="round" />
            </svg>
          );
        })}
