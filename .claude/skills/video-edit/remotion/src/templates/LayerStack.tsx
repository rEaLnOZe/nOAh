...
const FONT = "Alexandria, system-ui, sans-serif";
const LIME = "#FF7A00";
  ...
  return (
    <AbsoluteFill>
      ...
      <AbsoluteFill
        style={{
          background:
            "radial-gradient(58% 50% at 50% 54%, rgba(255,122,0,0.12) 0%, rgba(255,122,0,0) 60%)",
        }}
      />
          ...
          return (
            <div
              ...
              style={{
                ...
                borderRadius: radius,
                background: isAccent
                  ? `linear-gradient(180deg, #FFB25C 0%, ${LIME} 58%, ${LIME_DEEP} 100%)`
                ...
                boxShadow: isAccent
                  ? `0 ${lip}px 0 ${LIME_DEEP}, 0 ${lip + slabH * 0.08}px ${slabH * 0.3}px rgba(255,59,0,0.35), 0 ${lip + slabH * 0.1}px ${slabH * 0.28}px rgba(20,27,38,0.30), inset 0 1px 0 rgba(255,255,255,0.55)`
            ...
            >
              ...
              <div
                style={{
                  ...
                  boxShadow: isAccent ? "none" : `0 0 ${slabH * 0.12}px rgba(255,122,0,0.55)`,
                }}
              />
