...
const BLOCK_FONT_STACK = "'Alexandria', system-ui, sans-serif";
...
export const HookTitle: React.FC<HookTitleProps> = ({
  ...
  // Char-width multiplier for Alexandria Black at this weight — was 0.55
              ...
              <div style={{
                ...
                {logos.map((lp, i) => (
                  <div key={i} style={{
                    ...
                    boxShadow: "0 6px 18px rgba(0,0,0,0.45), 0 0 22px rgba(255,122,0,0.30)",
                    padding: width * 0.012,
