    ...
    <AbsoluteFill style={{ overflow: "hidden" }}>
      ...
      {title && (
        <div style={{
          ...
          <span style={{ color: "#FF7A00", marginRight: Math.round(typeBase * 0.018) }}>━</span>
          {title}
        </div>
      )}
      ...
      <div style={{
        ...
        {norm.map((b, i) => {
          ...
          const liveDisplay = b.display ?? (Number.isInteger(b.value)
            ...
            : (b.value * k).toFixed(1));
          const barColor = b.highlight ? "#FF7A00" : "#0F121A";
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    boxShadow: b.highlight
                      ? `0 ${Math.round(typeBase * 0.005)}px ${Math.round(typeBase * 0.014)}px rgba(255,122,0,0.40)`
