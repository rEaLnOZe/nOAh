  ...
  return (
    <AbsoluteFill style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div style={{
        ...
        <AbsoluteFill style={{
          ...
          <div style={{
            ...
            fontWeight: 700,
            fontSize: labelSize,
            color: winner === "top" ? "#FF7A00" : "#343E5B",
      ...
      <div style={{
        height: 4,
        background: "#FF7A00",
        boxShadow: "0 0 24px rgba(255,122,0,0.55)",
      ...
      <div style={{
        ...
        <AbsoluteFill style={{
          ...
          <div style={{
            ...
            fontWeight: 700,
            fontSize: labelSize,
            color: winner === "bottom" ? "#FF7A00" : "#B5BFC2",
            textTransform: "uppercase",
            letterSpacing: "0.10em",
            marginBottom: height * 0.022,
