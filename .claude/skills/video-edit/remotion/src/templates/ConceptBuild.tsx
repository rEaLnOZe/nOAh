...
const Element: React.FC<{
  ...
  const bg = isNote
    ? "transparent"
    : emph
      ? `radial-gradient(circle at 38% 30%, #FFB25C 0%, ${LIME} 60%, #FF3B00 100%)`
  ...
  // its lime halo.
  const shadow = emph
    ? `0 0 ${typeBase * (0.05 + 0.035 * hubPulse)}px rgba(255,122,0,${0.45 + 0.25 * hubPulse}), 0 0 ${typeBase * (0.1 + 0.05 * hubPulse)}px rgba(255,122,0,${0.18 + 0.12 * hubPulse}), 0 ${typeBase * 0.014}px ${typeBase * 0.034}px rgba(0,0,0,0.55)`
