      ...
      >
        ...
        <div
          style={{
            ...
            height: centerR * 2,
            borderRadius: "50%",
            background: `radial-gradient(circle at 35% 30%, #FFB25C 0%, ${LIME} 55%, ${LIME_DEEP} 100%)`,
            border: `${Math.max(2, typeBase * 0.004)}px solid ${INK}`,
            boxShadow: `0 0 ${typeBase * 0.05}px rgba(255,122,0,0.65), 0 ${typeBase * 0.012}px ${typeBase * 0.03}px rgba(20,27,38,0.30)`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: centerSize,
