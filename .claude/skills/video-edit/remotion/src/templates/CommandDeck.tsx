...
const LIME = "#FF7A00";
const LIME_DEEP = "#FF3B00";
const RAISIN = "#0F121A";
const PANEL_TOP = "#171C28";
const PANEL_BOT = "#0C0F16";
const BLOCK = "'Alexandria', system-ui, sans-serif";
  ...
  return (
    <AbsoluteFill style={{ opacity: groupOp }}>
      ...
      <div style={{
        ...
        boxShadow: "0 30px 90px rgba(0,0,0,0.6), 0 0 80px rgba(255,122,0,0.06), inset 0 1px 0 rgba(255,255,255,0.05)",
        opacity: panelOp,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              boxShadow: `0 0 ${dotR * 1.6}px rgba(255,122,0,0.6)`,
            }} />
            <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              boxShadow: `0 0 ${dotR * 1.4}px rgba(255,122,0,${livePulse})`, opacity: livePulse,
            }} />
            LIVE
          </div>
        </div>
        ...
        {tiles.map((t, i) => {
          ...
          const borderCol = `rgba(255,122,0,${0.12 + 0.55 * accent})`;
          ...
          const dotGlow = isActive ? `0 0 ${tileH * 0.08}px rgba(255,122,0,0.8)` : "none";
          ...
          return (
            <div key={i} style={{
              ...
              background: isActive
                ? `linear-gradient(180deg, rgba(255,122,0,0.08) 0%, rgba(255,122,0,0.02) 100%)`
                : "rgba(255,255,255,0.025)",
              border: `1.5px solid ${borderCol}`,
              boxShadow: isActive
                ? `0 8px 26px rgba(0,0,0,0.4), 0 0 ${tileH * 0.5}px rgba(255,122,0,${glowBreath})`
              ...
              {showSweep && (
                <div style={{
                  ...
                  width: "26%",
                  background: "linear-gradient(90deg, transparent, rgba(255,122,0,0.28), transparent)",
